...
from redzone.app import create_app
from redzone.database import db
from redzone.settings import DevConfig, ProdConfig
from redzone.user.models import User


CONFIG = ProdConfig if os.environ.get('REDZONE_SETTINGS') == 'prod' else DevConfig
